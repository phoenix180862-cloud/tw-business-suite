                                ...
                                <div>
                                    ...
                                    {kunde && (kunde.ag_email || kunde.bl_email || kunde.arch_email) && (
                                        <div style={{display:'flex', gap:'4px', marginTop:'4px', flexWrap:'wrap'}}>
                                            ...
                                            {kunde.bl_email && <button onClick={function(){setEmpfEmail(kunde.bl_email);}} style={{padding:'3px 7px', fontSize:'9px', background:'rgba(39,174,96,0.1)', color:'var(--success)', border:'1px solid rgba(39,174,96,0.2)', borderRadius:'5px', cursor:'pointer'}}>BL: {kunde.bl_email}</button>}
                                            {kunde.arch_email && <button onClick={function(){setEmpfEmail(kunde.arch_email);}} style={{padding:'3px 7px', fontSize:'9px', background:'rgba(230,126,34,0.1)', color:'var(--accent-orange)', border:'1px solid rgba(230,126,34,0.2)', borderRadius:'5px', cursor:'pointer'}}>Arch: {kunde.arch_email}</button>}
                                        </div>
                                    )}
                                </div>
                            )}
