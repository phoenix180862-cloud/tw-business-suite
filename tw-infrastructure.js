    ...
    const GEMINI_CONFIG = {
        ...
        MODEL_PRO_31: 'gemini-2.5-pro-preview-06-05',
        MODELS: {
            'flash': { id: 'gemini-2.5-flash', name: 'Gemini 2.5 Flash', icon: '⚡', desc: 'Schnell & günstig', color: '#1E88E5' },
            'pro': { id: 'gemini-2.5-pro', name: 'Gemini 2.5 Pro', icon: '🧠', desc: 'Präzise Analyse', color: '#8e44ad' },
            'pro31': { id: 'gemini-2.5-pro-preview-06-05', name: 'Gemini 2.5 Pro Preview', icon: '🚀', desc: 'Neuestes Modell', color: '#e74c3c' }
        },
    ...
    window.GoogleDriveService = {
        ...
        async exportToCustomerFolder(kundeFolderId, pdfBlob, excelBlob, kundenName) {
            ...
            const aufmassFolderId = await this.findOrCreateFolder(kundeFolderId, 'Aufmaß');
