        ...
        function RechnungsModul({ kunde, importResult, gesamtliste, aufmassGespeichert, onBack }) {
            ...
            var generatePDF=function(){
                ...
                // "Thomas": gerade (bold, NICHT italic), von w-Linkskante bis Punkt-Rechtskante
                var dotRight=iMid+1.1;
                doc.setFont('helvetica','bold');doc.setFontSize(11);doc.setTextColor(196,30,30);
                // Unterkante Thomas knapp ueber Oberkante roter Punkt (y+9.5)
                doc.text('Thomas',ML,y+9.2);
