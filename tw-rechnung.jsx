        ...
        function RechnungsModul({ kunde, importResult, gesamtliste, aufmassGespeichert, onBack }) {
            ...
            var generatePDF=function(){
                ...
                // Roter Punkt bei y+9.1
                doc.setFillColor(196,30,30);doc.rect(iMid-1.1,y+9.1,2.2,2.2,'F');
                lx+=iW;
                ...
                doc.setFont('helvetica','bold');doc.setFontSize(9);doc.setTextColor(196,30,30);
                doc.text('Thomas',ML,y+8.8);
