        ...
        function NeueEinladungDialog({ onSchliessen, onErstellen }) {
            ...
            async function handleErstellen() {
                ...
                setBusy(true);
                try {
                    var tage = parseInt(gueltigTage, 10) || 30;
                ...
                <div
                    ...
                    <div
                        ...
                        <div style={{ marginBottom:'14px' }}>
                            ...
                            <div style={{ display:'flex', gap:'6px' }}>
                                {[{tage:'30',label:'1 Monat'},{tage:'180',label:'6 Monate'},{tage:'365',label:'12 Monate'}].map(function(opt) {
                                    var aktiv = gueltigTage === opt.tage;
                                    return (
                                        <button
                                            key={opt.tage}
                                            onClick={function(){ setGueltigTage(opt.tage); }}
                                            style={{
