        ...
        function BaustellenAppAdmin({ kunde, onBack }) {
            ...
            async function handleSetMapping(uid, maId, name) {
                if (!maId) { alert('Bitte Mitarbeiter waehlen.'); return; }
                try {
                    await window.FirebaseService.setUserMaId(uid, maId);
                    // ma_id_skipped-Marker entfernen falls vorhanden
                    try { await window.FirebaseService.db.ref('users/'+uid+'/ma_id_skipped').remove(); } catch(e) {}
        ...
        function TeamVerwaltung({ fbOk, users, invitations, auditLog, onApprove, onReject, onCreateInvitation, onWiderrufeInvitation, onDeleteInvitation, onLockDevice, onUnlockDevice, onRemoveDevice, onOpenMapping, onBack }) {
            ...
            // ── F3: freigegebene Geraete ohne ma_id (und ohne Skip-Marker) ──
                        ...
                        {users.pending.length > 0 && (
                            <div className="ba-card">
                                ...
                                <div style={{
                                    ...
                                    Bitte vor dem Freigeben den passenden Mitarbeiter waehlen,
        ...
        // ═══════════════════════════════════════════════════════
        // PENDING DEVICE ROW (Fix 22.04.2026 · F2)
        // Einzelne Zeile in "Wartende Freigaben" mit Slug-Dropdown.
        // Automatische Vorauswahl via Namens-Matching.
        // ═══════════════════════════════════════════════════════
        ...
        // ═══════════════════════════════════════════════════════
        // GERAETE-MAPPING (Fix 22.04.2026 · F1)
        // Admin-Werkzeug zur nachtraeglichen Zuordnung existierender
        // Geraete (UIDs) zu Mitarbeiter-Slugs. Loest Bestandsgeraete
        // ohne ma_id-Feld.
        // ═══════════════════════════════════════════════════════
                ...
                <div className="page-container" style={{ padding:'16px', minHeight:'100vh' }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ color:'var(--text-muted)' }}>
                            Geraete, die frueher ohne Mitarbeiter-Zuordnung freigegeben wurden,
