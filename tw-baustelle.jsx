                        ...
                        <div>
                            ...
                            {!published ? (
                                ...
                                <div className="ba-card" style={{borderColor:'rgba(39,174,96,0.3)'}}>
                                    <div className="ba-card-title" style={{color:'#27ae60'}}>✅ Baustelle ist live</div>
                                    <p style={{fontSize:'13px', color:'var(--text-muted)', lineHeight:'1.5', marginBottom:'14px'}}>
                ...
                <div>
                    <div className="ba-card">
                        ...
                        <div className="ba-stats">
                            ...
                            <div className="ba-stat"><div className="ba-stat-val" style={{color:'#27ae60'}}>🟢</div><div className="ba-stat-lbl">Firebase</div></div>
                        </div>
