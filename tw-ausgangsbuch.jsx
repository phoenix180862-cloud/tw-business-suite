        function RechnungsAusgangsbuch({ kunde, onBack }) {
            ...
            var renderSettings = function() {
                ...
                return React.createElement('div', { style: { padding: '16px' } },
                    ...
                    [
                        { key: 'standardZahlungsziel', label: 'Standard-Zahlungsziel (Tage)', type: 'text', isNum: true },
                        { key: 'standardMwst', label: 'Standard MwSt-Satz (%)', type: 'text', isNum: true },
                        { key: 'standardSkonto', label: 'Standard Skonto (%)', type: 'text', isNum: true },
                        { key: 'standardSkontoTage', label: 'Standard Skonto-Frist (Tage)', type: 'text', isNum: true },
                        { key: 'alarmTageVorher', label: 'Alarm X Tage vor Zahlungsziel', type: 'text', isNum: true },
                    ].map(function(field) {
